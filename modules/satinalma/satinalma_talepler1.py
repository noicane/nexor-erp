...
class SatinalmaTaleplerPage(BasePage):
    ...
    def __init__(self, theme: dict, kullanici_id=None):
        super().__init__(theme)
        
        # kullanici_id opsiyonel - yoksa varsayılan 1
        self.kullanici_id = kullanici_id if kullanici_id is not None else 1
    ...
    def _check_approval_authority(self):
        ...
        # BASİT ÇÖZÜM: HERKES ONAYLAYABİLİR
        self.has_approval_authority = True
