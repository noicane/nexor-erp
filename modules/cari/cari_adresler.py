...
class CariAdreslerPage(BasePage):
    ...
    def update_theme(self, theme: dict = None):
        """Brand tokenlarini tazele — tam restyle icin sayfa yeniden olusmali."""
        self.theme = theme
        self.s = get_modern_style(theme)
        # Tabloyu yeniden yukle (satir renkleri brand'den gelsin)
        try:
            if hasattr(self, '_load_adresler') and self.selected_cari_id:
                self._load_adresler()
        except Exception:
            pass
