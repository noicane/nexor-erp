# -*- coding: utf-8 -*-
"""
REDLINE NEXOR ERP - Banyo TDS (Technical Data Sheet) Modulu
...
class TDSDialog(QDialog):
    """Yeni TDS tanimlama veya mevcut TDS duzenleme"""
    ...
    def _setup_ui(self):
        ...
        save_btn.setStyleSheet(f"background: {self.theme['primary']}; color: white; border: none; "
                               f"padding: 10px 20px; border-radius: 6px; font-weight: bold;")
...
class TDSAIAnalizPanel(QWidget):
    """AI destekli analiz paneli - 4 analiz karti (2x2 grid)"""
    ...
    def _setup_ui(self):
        ...
        # Basla butonu
        top_bar = QHBoxLayout()
        self.analiz_btn = QPushButton("Analiz Baslat")
        ...
        self.risk_label.setStyleSheet(f"color: {self.theme['text']}; font-weight: bold; font-size: 14px;")
        ...
        self.karsilastirma_group.setStyleSheet(self._group_style())
        ...
        self.karsilastirma_table.verticalHeader().setVisible(False)
        self.karsilastirma_table.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.karsilastirma_table.setMaximumHeight(200)
        ...
        self.trend_group.setStyleSheet(self._group_style())
        ...
        if MATPLOTLIB_AVAILABLE:
            ...
            self.trend_canvas.setMaximumHeight(200)
        ...
        self.tahmin_table.verticalHeader().setVisible(False)
        self.tahmin_table.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.tahmin_table.setMaximumHeight(200)
        ...
        self.takviye_group.setStyleSheet(self._group_style())
        ...
        self.takviye_table.verticalHeader().setVisible(False)
        self.takviye_table.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.takviye_table.setMaximumHeight(200)
        tv_layout.addWidget(self.takviye_table)
        self.takviye_olustur_btn = QPushButton("Takviye Olustur")
        self.takviye_olustur_btn.setStyleSheet(
    ...
    def _group_style(self):
        return (f"QGroupBox {{ color: {self.theme['text']}; font-weight: bold; "
                f"border: 1px solid {self.theme['border']}; border-radius: 8px; "
                f"margin-top: 10px; padding-top: 14px; background: {self.theme['bg_card_solid']}; }}"
    ...
    def _get_son_olcumler(self) -> dict:
        ...
        try:
            ...
            print(f"Son olcumler alinamadi: {e}")
        return olcumler
    ...
    def _get_veri_serisi(self, gun: int = 30) -> list:
        ...
        try:
            ...
            print(f"Veri serisi alinamadi: {e}")
        return veri
    ...
    def _run_analiz(self):
        ...
        if not self.tds_id or not self.tds_parametreler:
            QMessageBox.warning(self, "Uyari", "Lutfen once bir TDS secin ve parametreleri tanimlayın!")
            return
        ...
        try:
            ...
            # TDS parametreleri dict listesine cevir
            tds_params = []
            ...
            renk_map = {"NORMAL": "#10B981", "UYARI": "#F59E0B", "KRITIK": "#E2130D"}
            self.risk_label.setText(f"Risk: {risk}")
            self.risk_label.setStyleSheet(f"color: {renk_map.get(risk, '#ffffff')}; font-weight: bold; font-size: 14px;")
    ...
    def _goster_karsilastirma(self, data: list):
        ...
        for i, k in enumerate(data):
            ...
            if durum == "NORMAL":
                durum_item.setForeground(QColor("#10B981"))
            elif durum == "UYARI":
                durum_item.setForeground(QColor("#F59E0B"))
            elif durum == "KRITIK":
                durum_item.setForeground(QColor("#E2130D"))
    ...
    def _goster_trend(self, data: list, veri_serisi: list):
        if MATPLOTLIB_AVAILABLE and veri_serisi:
            ...
            # Parametrelere gore grupla ve ciz
            param_gruplari = {}
    ...
    def _goster_tahmin(self, data: list):
        ...
        for i, t in enumerate(data):
            ...
            renk_map = {"NORMAL": "#10B981", "DUSUK": "#F59E0B", "YUKSEK": "#E2130D"}
            risk_item.setForeground(QColor(renk_map.get(risk, "#ffffff")))
    ...
    def _goster_takviye(self, data: list):
        ...
        for i, t in enumerate(data):
            ...
            oncelik_renk = {"ACIL": "#E2130D", "YUKSEK": "#F59E0B", "ORTA": "#3B82F6", "DUSUK": "#10B981"}
            oncelik_item.setForeground(QColor(oncelik_renk.get(oncelik, "#ffffff")))
...
class BanyoTDSTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.sub_tabs.setStyleSheet(f"""
            ...
            QTabBar::tab {{ background: {self.theme['bg_input']}; padding: 6px 14px; color: {self.theme['text']}; }}
    ...
    def _create_dosya_tab(self):
        ...
        self.dosya_table.setColumnWidth(1, 80)
        self.dosya_table.setColumnWidth(2, 80)
        self.dosya_table.setColumnWidth(3, 120)
        self.dosya_table.setColumnWidth(4, 0)
        self.dosya_table.setColumnHidden(4, True)
        self.dosya_table.verticalHeader().setVisible(False)
        self.dosya_table.setSelectionBehavior(QAbstractItemView.SelectRows)
        self.dosya_table.setEditTriggers(QAbstractItemView.NoEditTriggers)
    ...
    def _create_parametre_tab(self):
        ...
        self.param_table.setColumnWidth(0, 110)
        self.param_table.setColumnWidth(2, 70)
        self.param_table.setColumnWidth(3, 80)
        self.param_table.setColumnWidth(4, 80)
        self.param_table.setColumnWidth(5, 80)
        self.param_table.setColumnWidth(6, 80)
        self.param_table.setColumnWidth(7, 50)
    ...
    def _load_tds_list(self):
        ...
        try:
            ...
            print(f"TDS listesi yuklenemedi: {e}")
        self.tds_combo.blockSignals(False)
    ...
    def _on_tds_changed(self):
        ...
        if tds_id:
            ...
            # AI paneline parametreleri ilet
    ...
    def _dosya_sil(self):
        ...
        try:
            ...
            # Fiziksel dosyayi sil (opsiyonel - NAS'tan)
    ...
    def _load_parametreler(self):
        ...
        try:
            ...
            for i, row in enumerate(rows):
                # Parametre kodu (editable)
                kod_item = QTableWidgetItem(row[1] or '')
                kod_item.setData(Qt.UserRole, row[0])  # DB ID
            ...
            print(f"Parametreler yuklenemedi: {e}")
    ...
    def _banyo_param_kopyala(self):
        ...
        try:
            ...
            # Parametre haritalama: (kodu, min_idx, hedef_idx, max_idx)
            harita = [
    ...
    def _param_kaydet(self):
        ...
        try:
            ...
            # Mevcut parametreleri sil ve yeniden ekle (basit yaklasim)
    ...
    def save_tds_data(self):
        ...
        # Parametreler tabloda degisiklik varsa otomatik kaydet
