# -*- coding: utf-8 -*-
"""
REDLINE NEXOR ERP - Placeholder Sayfa
Henüz geliştirilmemiş sayfalar için şablon
"""
...
class PlaceholderPage(BasePage):
    """Yapım aşamasındaki sayfalar için placeholder"""
    
    def __init__(self, theme: dict, title: str = "Sayfa", icon: str = "📄"):
