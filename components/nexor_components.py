...
# =============================================================================
# TEMA RENKLERI (Global Erisim)
# =============================================================================

def get_theme_colors(theme: dict) -> dict:
    """Tema renklerini dondur, eksik olanlari varsayilan ile doldur"""
    defaults = {
        # Arka planlar
        "bg_main": "#0F0F0F",
        "bg_card": "#1A1A1A",
        ...
        "table_header_text": "#888888",
        "table_row_bg": "#1A1A1A",
        "table_row_alt": "#151515",
        "table_row_hover": "#222222",
        "table_border": "#2A2A2A",
    }
    
    # Tema degerlerini varsayilanlarla birlestir
...
class BorderRadius:
    """Standart border-radius degerleri"""
    SM = 6
    MD = 8
    LG = 12
    XL = 16
...
class NexorCard(QFrame):
    ...
    def __init__(self, theme: dict, title: str = None, parent=None):
...
class NexorStatsCard(QFrame):
    ...
    def __init__(self, theme: dict, title: str, value: str,
    ...
    def _setup_ui(self):
        ...
        if self._icon:
            ...
            # Light mode'da acik, dark mode'da koyu arka plan
            mode = t.get('mode', 'dark')
            if mode == 'light':
                icon_bg = self._hex_lighten(self._color, 0.9)  # Cok acik versiyon
            else:
                icon_bg = self._hex_to_rgba(self._color, 0.15)  # Koyu versiyon
        ...
        # Trend
        if self._trend:
            trend_color = t['success'] if self._trend_up else t['error']
    ...
    def set_trend(self, trend: str, trend_up: bool):
        ...
        if hasattr(self, '_trend_label'):
            t = self.theme
            trend_color = t['success'] if trend_up else t['error']
...
class NexorButton(QPushButton):
    ...
    def __init__(self, text: str, theme: dict, variant: str = "secondary", 
...
class NexorBadge(QLabel):
    ...
    def __init__(self, text: str, theme: dict, variant: str = "default", parent=None):
    ...
    def _apply_style(self):
        ...
        colors = {
            ...
            "default": (t['bg_hover'], t['text_secondary']),
        }
...
class NexorInput(QLineEdit):
    ...
    def __init__(self, theme: dict, placeholder: str = "", parent=None):
        super().__init__(parent)
        self.theme = get_theme_colors(theme)
    ...
    def _setup_ui(self):
        ...
        self.setStyleSheet(f"""
            ...
            QHeaderView::section:first {{
                border-top-left-radius: {BorderRadius.LG}px;
            }}
            QHeaderView::section:last {{
                border-top-right-radius: {BorderRadius.LG}px;
            }}
            QScrollBar:vertical {{
                background: {t['bg_card']};
                width: 10px;
...
class NexorFormField(QWidget):
    ...
    def __init__(self, label: str, widget: QWidget, theme: dict, 
...
class NexorForm(NexorCard):
    ...
    def __init__(self, theme: dict, title: str = None, columns: int = 2, parent=None):
...
class NexorPageHeader(QWidget):
    ...
    def __init__(self, theme: dict, title: str, subtitle: str = None,
...
class NexorModal(QDialog):
    ...
    def __init__(self, theme: dict, title: str, message: str = None,
...
class NexorSearchBox(QLineEdit):
    ...
    def __init__(self, theme: dict, placeholder: str = "Ara... (Ctrl+K)", parent=None):
        super().__init__(parent)
        self.theme = get_theme_colors(theme)
